...
func (_m *EcstEventBuilder) Body(body models.DiscoveryBody) workloadsmodels.EcstEventBuilder {
	ret := _m.Called(body)
...
func (_c *EcstEventBuilder_Body_Call) Return(_a0 workloadsmodels.EcstEventBuilder) *EcstEventBuilder_Body_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *EcstEventBuilder_Body_Call) RunAndReturn(run func(models.DiscoveryBody) workloadsmodels.EcstEventBuilder) *EcstEventBuilder_Body_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EcstEventBuilder) Header(header models.HeaderProperties) workloadsmodels.EcstEventBuilder {
...
func (_c *EcstEventBuilder_Header_Call) Return(_a0 workloadsmodels.EcstEventBuilder) *EcstEventBuilder_Header_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *EcstEventBuilder_Header_Call) RunAndReturn(run func(models.HeaderProperties) workloadsmodels.EcstEventBuilder) *EcstEventBuilder_Header_Call {
	_c.Call.Return(run)
	return _c
}
